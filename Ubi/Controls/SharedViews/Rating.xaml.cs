...
namespace Ubi
{
    ...
    {
        private string RATING_EMPTY_ICON_CHAR = GrialIconsFont.Star;
        private string RATING_PARTIAL_ICON_CHAR = GrialIconsFont.StarHalf;
        private string RATING_FULL_ICON_CHAR = GrialIconsFont.StarFill;
