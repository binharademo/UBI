...
namespace Ubi.iOS
 {
	internal class ThemeColors : ThemeColorsBase
	{
		private readonly static Dictionary<string, Color> _themeColors = new Dictionary<string, Color>
		{
			...
			{ "AccentColor", Color.FromHex("#CA2715") },
			{ "BaseTextColor", Color.FromHex("#666666") },
			{ "ListViewSelectedItemBackgroundColor", Color.FromHex("#11000000") },
			{ "SplashBackgroundColor", Color.FromHex("#CA2715") },
			{ "BrandBlockTextColor", Color.FromHex("#FFFFFF") },
			{ "BrandBlockBackgroundColor", Color.Transparent },
			{ "NavigationBarStartBackgroundColor", Color.FromHex("#910000") },
			{ "NavigationBarEndBackgroundColor", Color.FromHex("#CA2715") },
			...
			{ "TagItemBackgroundColor", Color.FromHex("#CA2715") },
			...
			{ "ComplementColor", Color.FromHex("#ea4735") },
			...
			{ "PrimaryActionButtonStartColor", Color.FromHex("#910000") },
			{ "PrimaryActionButtonEndColor", Color.FromHex("#CA2715") },
